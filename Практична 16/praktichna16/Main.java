...
import static praktichna16.file.FilesystemUtilities.*;
import static praktichna16.winCheck.*;
                ...
                case "2": {
                    ...
                    while (done) {
                        ...
                        switch (input_str) {
                            ...
                            case "4":{
                                saveSettings(startSymbol, size, playingAgainstRandom);
                                System.out.println("Налаштування збережено");
                                break;
                            }
                            case "5": {
                                loadSettings(startSymbol, size, playingAgainstRandom);
